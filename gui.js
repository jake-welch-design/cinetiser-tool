...
class GUIController {
  ...
  initializeCutsGrid() {
    ...
    console.log(
      "✅ Cut parameters map initialized with per-cut parameters only"
    );
  ...
  selectCut(cutIndex) {
    ...
    console.log(
      `  Global: imagePosX = ${this.parameters.imagePosX}, imagePosY = ${this.parameters.imagePosY}`
    );
